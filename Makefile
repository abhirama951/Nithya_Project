# ========================================================
# Makefile for Microwatt + LMS Peripheral
# ========================================================
...
# ========================================================
# LMS Peripheral Integration
# ========================================================
WB_LMS      = peripherals/wb_lms.v
LMS_WRAPPER = vhdl/lms_wrapper.vhdl

# Compile wb_lms Verilog into GHDL
$(WB_LMS):
	@echo "Compiling wb_lms Verilog..."
	$(GHDL) -a --std=08 --work=work --vhdl-verilog $(WB_LMS)

# Compile lms_wrapper, depends on wb_lms
$(LMS_WRAPPER): $(WB_LMS)
	@echo "Compiling LMS wrapper..."
	$(GHDL) -a --std=08 --work=work $(LMS_WRAPPER)
...
# Compile SoC testbenches with LMS wrapper
$(soc_flash_tbs): %: $(soc_sim_files) $(soc_sim_obj_files) $(unisim_lib) $(fmf_lib) $(flash_model_files) $(LMS_WRAPPER) %.vhdl
	$(GHDL) -c $(GHDLFLAGS) $(soc_sim_link) $(soc_sim_files) $(flash_model_files) $@.vhdl -e $@

$(soc_tbs): %: $(soc_sim_files) $(soc_sim_obj_files) $(unisim_lib) $(LMS_WRAPPER) %.vhdl
...
# Add your existing FPGA target configurations here...
# (unchanged from original Makefile)
